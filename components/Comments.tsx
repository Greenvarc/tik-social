...
function Comments({isPostingComment,comment,comments,setComment,addComment}:Props) {
    
    const {userProfile,allUsers}=useAuthStore()

  return ( 
    <div className='border-t-2 border-gray-200 pt-4 px10 bg-[#f8f8f8] border-b-2 lg:pb-0 pb-[100px]'>
